...
def main(argv: list[str] = None) -> None:
    ...
    # The parent only prints a settings summary; each worker installs its own config.
    # Use the first expanded experiment so the summary is concrete even if an LLM
    # flag becomes sweepable in the future.
